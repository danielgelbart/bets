...
class FightsControllerTest < ActionController::TestCase
  ...
  test "should create fight" do
    assert_difference('Fight.count') do
      post :create, fight: { date: @fight.date, event: @fight.event, loser: @fight.loser, round: @fight.round, time: @fight.time, winner: @fight.winner }
    end
  ...
  test "should update fight" do
    patch :update, id: @fight, fight: { date: @fight.date, event: @fight.event, loser: @fight.loser, round: @fight.round, time: @fight.time, winner: @fight.winner }
    assert_redirected_to fight_path(assigns(:fight))
  end
