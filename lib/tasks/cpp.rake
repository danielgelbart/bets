...
task :mm => :environment do
  ...
  MetaMapper.generate(:cpp, :orm => :activerecord, :models => models, :template_dir => '../../../../rankabove/dm-metamapper/templates/', :output_dir => File.expand_path('../../../../bets/cpp/src/dmmm/', __FILE__))
end
